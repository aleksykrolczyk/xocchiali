...
static void gatts_profile_event_handler2(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param);
...
static struct gatts_profile_inst GATTS_PROFILE = {
        .gatts_cb = gatts_profile_event_handler2,
